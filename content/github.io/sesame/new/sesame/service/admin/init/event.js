import { TokenVerification } from "/content/github.io/sesame/service/admin/connect/token_verif.js";
import { FetchContent } from "/content/github.io/utils/NFC-modules/scripts/init/provider.js";
import { LoadUI } from "/content/github.io/sesame/scripts/utils/UI.js";
import { SessionState, GetSession,SetSession } from "/content/github.io/sesame/service/admin/connect/storage.js";
...
export async function AddInitListeners() {
    ...
    LogIn.addEventListener('click',async function() {
        ...
        async function DisplayTokenResult() {
            ...
            if (verification) {
                contentLoad = await FetchContent('/content/github.io/utils/uis/sesame/admin/connect/success.txt',"txt");
                session.name = userName;
                session.token = token;
                SetSession(parameters.adminSession.name,session);
            } else {
                contentLoad = await FetchContent('/content/github.io/utils/uis/sesame/admin/connect/failure.txt',"txt");
            }
