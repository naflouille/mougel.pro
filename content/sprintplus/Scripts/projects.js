  ...
  <div class="pj-board-parent">
    ...
    <div class="wholedetailsinfos" onclick="HoverShow('details')">
      ...
      <div class="pj-b-details-c">
        ...
        <div>
          ${pj.inspi?(pj.inspi.length>1?pj.inspi.length+" elements inspire this project":pj.inspi.length+"element inspires this project"):""} 
        </div>
        <p>
          Tasks
        </p>
        <div>
          ${pj.tasks?(pj.tasks.length>1?pj.tasks.length+" tasks made for this project":pj.tasks.length+"task made for this project"):""} 
        </div>
      </div>
